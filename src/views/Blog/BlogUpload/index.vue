      ...
      <div class="part">
        ...
        >
          <el-button
            ...
            @click="handleClearAllFile"
            >清除所有文件</el-button
          >
          <el-popover slot="right-footer" placement="top" v-model="visible">
            <el-select
              v-model="categoryId"
              placeholder="请选择一个分类"
              size="medium"
    ...
    handleFilesSelected(event) {
      ...
      Array.from(files).forEach((file) => {
        ...
        reader.onload = function (e) {
          ...
          const contentWithoutTitle = content.replace(/^# .+$/gm, ""); // 将标题从内容中删除
          ...
          const blogData = {
            title: title && title[1],
            htmlContent: md.render(contentWithoutTitle),
            description,
            categoryId: null,
