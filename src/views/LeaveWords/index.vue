<template>
  <div class="leavewords-container app-container">
    <!-- 数据表格 -->
    <!-- 数据表格 -->
    <!-- 数据表格 -->
    <el-table
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <el-tooltip class="item" effect="dark" content="删除留言" :hide-after="1500" placement="top" :open-delay="750">
...
export default {
  ...
  methods: {
    ...
    /** 删除评论 */
    handleDeleteButtonClick(messageInfo) {
